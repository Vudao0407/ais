...
class Conversation_history:
    ...
    def add_item(self, message_type: str, message: str):
        ...
        item = {'message_type': message_type, 'message': message,
...
class Conversation_history_plugin:
    ...
    def add_response(self, message):
        self.__conversation_history.add_item(
            message_type='RESPONSE', message=message)
        return self

    def add_command(self, message):
        self.__conversation_history.add_item(
            message_type='COMMAND', message=message)
        return self
...
def initialize():
    ...
    plugins.plugin_factory.register(
        'conversation_history_plugin', Conversation_history_plugin)
